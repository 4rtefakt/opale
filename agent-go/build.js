...
const DEFAULT_BRANDING = {
  ...
  legacyDataDirName:      '',
  legacyServiceName:      '',  // ancien Windows Service à désinstaller (install.ps1)
}
...
const flagOverrides = {
  ...
  legacyServiceName:      flagValue('--legacy-service-name'),
}
...
const replacements = [
  ...
  ["'##LEGACY_SERVICE_NAME##'",  `'${branding.legacyServiceName}'`],
]
let out = tmpl
